...
fil1 = strcat('k3_d2_d10_redk2/additivese_mean_D', int2str(D), '_K', int2str(actualK) , '.csv');
fil2 = strcat('k3_d2_d10_redk2/additivese_std_D', int2str(D), '_K', int2str(actualK) , '.csv');
