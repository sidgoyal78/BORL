function [finalans] =  evaluation_2dimadditive(input, output, N, trainsize)
...
minval = [];
for i = 1:2
	[sgp1, sgp1_nlml] = train_2dim_additive(sgp1, 10, [400 400])
	if isempty(op)
		minval = sgp1_nlml;
		op = sgp1.hyp;
	else
...
covfunc = {'covSum', {'covSE_dim2_randomadditive', 'covNoise'}};
sgp1.hyp = op;
sgp1_nlml = minval;
